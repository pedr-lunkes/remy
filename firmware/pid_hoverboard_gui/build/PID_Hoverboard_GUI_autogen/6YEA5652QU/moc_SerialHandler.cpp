...
QT_MOC_LITERAL(1, 14, 10), // "rpmUpdated"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "rpm1"
QT_MOC_LITERAL(4, 31, 4), // "rpm2"
QT_MOC_LITERAL(5, 36, 8), // "readData"
QT_MOC_LITERAL(6, 45, 9) // "updatePID"

    },
    "SerialHandler\0rpmUpdated\0\0rpm1\0rpm2\0"
    "readData\0updatePID"
};
...
void SerialHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->rpmUpdated((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        case 1: _t->readData(); break;
        case 2: _t->updatePID(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SerialHandler::*)(float , float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialHandler::rpmUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialHandler::rpmUpdated(float _t1, float _t2)
{
