...
class Odom_pub(Node):
    ...
    def __init__(self):
        ...
        self.odom_pub_ = self.create_publisher(Odometry, "remy_odom/odom", 10)
    ...
    def jointCallback(self, msg:JointState):
        ...
        q = Quaternion()
        q.w = math.cos(self.theta_ / 2.0)
        q.x = 0.0
        q.y = 0.0
        q.z = math.sin(self.theta_ / 2.0)
        ...
        self.odom_msg_.pose.pose.orientation.x = q.x
        self.odom_msg_.pose.pose.orientation.y = q.y
        self.odom_msg_.pose.pose.orientation.z = q.z
        self.odom_msg_.pose.pose.orientation.w = q.w
        ...
        self.transform_stamped_.transform.rotation.x = q.x
        self.transform_stamped_.transform.rotation.y = q.y
        self.transform_stamped_.transform.rotation.z = q.z
        self.transform_stamped_.transform.rotation.w = q.w
